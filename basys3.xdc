...
#set_property PACKAGE_PIN W15 [get_ports {b1[3]}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {b1[3]}]
#set_property PACKAGE_PIN V15 [get_ports {b1[2]}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {b1[2]}]
#set_property PACKAGE_PIN W14 [get_ports {b1[1]}]                                       
...
#set_property PACKAGE_PIN V2 [get_ports {b2[3]}]                                        
#        set_property IOSTANDARD LVCMOS33 [get_ports {b2[3]}]
#set_property PACKAGE_PIN T3 [get_ports {b2[2]}]                                        
#        set_property IOSTANDARD LVCMOS33 [get_ports {b2[2]}]
#set_property PACKAGE_PIN T2 [get_ports {b2[1]}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {b2[1]}]
#set_property PACKAGE_PIN R3 [get_ports {b2[0]}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {b2[0]}]
#set_property PACKAGE_PIN W2 [get_ports {b3[3]}]                                       
#        set_property IOSTANDARD LVCMOS33 [get_ports {b3[3]}]
#set_property PACKAGE_PIN U1 [get_ports {b3[2]}]                                       
